...
category_descriptions:
  ...
  security: Details on WAF security rules (Front Door DRS), bot protection on Application
    Gateway, and enforcing WAF configurations and governance using Azure Policy.
